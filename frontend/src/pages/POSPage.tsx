...
export default function POSPage() {
  ...
  const { data, loading, error, refetch } =
    useFetch<ApiResponse<Product[]>>(url);

  // Escuchar evento personalizado para actualizar los productos en la App
  useEffect(() => {
    const handleProductosUpdate = () => {
      refetch();
    };

    window.addEventListener("productosUpdated", handleProductosUpdate);
    return () =>
      window.removeEventListener("productosUpdated", handleProductosUpdate);
  }, [refetch]);
