...
INSERT INTO "new_productos" ("activo", "actualizado_en", "categoriaId", "creado_en", "descripcion", "id", "nombre", "permiteExclusiones", "permiteExtras", "precio_base") SELECT "activo", "actualizado_en", "categoriaId", "creado_en", "descripcion", "id", "nombre", "permiteExclusiones", "permiteExtras", "precio_base" FROM "productos";
